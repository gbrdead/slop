...
The AI proponents and even most of the sceptics suggest the following counter-measure to hallucinations and low readability: code reviews by seasoned programmers. This may work only in the short term. Here is why:
...
### The Next Level of Distraction

A particular fallacy is being brought up by the AI proponents so frequently that it cannot be ignored:

*LLM-assisted coding is the next level of abstraction - just like compilers were in the past.*
...
But sloppy art and insecure software are by far not the greatest dangers of LLMs. The latter can be used for much worse things:

- Disinformation campaigns (e.g. targeted slop in the social networks)
- Mass surveillance with immediate analysis of writen and spoken text. LLMs can be way more effective than [the millions of informants of Stasi](https://en.wikipedia.org/wiki/Stasi#Personnel_and_recruitment). The occasional inaccuracies are not a big problem - even a relatively low success rate guarantees that no dissident will stay undetected for long.
